...
class SocA1Widget extends StatefulWidget {
  const SocA1Widget({Key key}) : super(key: key);

  @override
  _SocA1WidgetState createState() => _SocA1WidgetState();
}

class _SocA1WidgetState extends State<SocA1Widget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        backgroundColor: Color(0x6B5B7DB1),
        iconTheme:
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(100, 0, 0, 30),
                          child: InkWell(
                            onTap: () async {
                              await Share.share('');
                            },
